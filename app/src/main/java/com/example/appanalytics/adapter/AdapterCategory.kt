...
import com.example.appanalytics.news.Categories

class AdapterCategory(private var contactList: ArrayList<Categories>,  val listener: OnClickCategory) : RecyclerView.Adapter<AdapterCategory.MyViewHolder>() {
